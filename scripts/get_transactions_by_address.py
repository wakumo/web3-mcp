#!/usr/bin/env python3
"""Test tool get_transactions_by_address"""
...
async def test_get_transactions_by_address():
    """Test get_transactions_by_address tool"""
    try:
    ...
    print("=" * 70)
    print("TEST: get_transactions_by_address")
    print("=" * 70)
    ...
    try:
        ...
        async with stdio_client(server_params) as (read, write):
            async with ClientSession(read, write) as session:
                ...
                print(f"\n🔍 Calling tool 'get_transactions_by_address'...")
...
if __name__ == "__main__":
    asyncio.run(test_get_transactions_by_address())
